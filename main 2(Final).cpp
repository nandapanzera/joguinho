...
char mat[25][25],t;                                   
int i,l,c,p=0,ccx,ccy,y,cont=0,movimento = 0,z=0,s=0,o=0,e=0,pp=0,ss=0,x=2,bot=0,h=0,ee=0,tt=0,sss=0,x1=2,oo=0,qq=0,qq2=0,kk=0;
...
void Combate(Hero x, Vilan& y)
{
    ...
    int dado = rand()%6 + 1;   // Gerando um valor aleatório entre 1 e 6 ('jogada )de um dado de 12 lados
	...
	char lixo;
	 	...
	 	if(heroi.pv <= 0 || vilao.pv <= 0)
		{
	 	...
	 	if(heroi.pv > vilao.pv)
		 {
		 	...
		 	cout << "E passa com alegria pelo portal!\n";
...
void VitoriaFinal()
{   system("cls");
cout <<"        db    db d888888b d888888b  .d88b.  d8888b. d888888b  .d8b.       \n";
cout <<"        88    88    88     ~88~  .8P  Y8. 88   8D    88    d8   8b      \n";
cout <<"        Y8    8P    88       88    88    88 88oobY'    88    88ooo88      \n";
cout <<"        `8b  d8'    88       88    88    88 88`8b      88    88~~~88      \n";
cout <<"         `8bd8'    .88.      88    `8b  d8' 88 `88.   .88.   88   88      \n";
cout <<"           YP    Y888888P    YP     `Y88P'  88   YD Y888888P YP   YP       \n";

	cout <<"\nParabéns! Você completou todas as fases e chegou ao final do jogo!\n";
	system("pause");	
	movimento = 0,z=0,s=0,o=0,e=0,pp=0,ss=0,x=2,bot=0,h=0,ee=0,tt=0,sss=0,x1=2,oo=0,qq=0,qq2=0,kk=0,cont=0,p=0;
}
